...
/**
 * @dev Extension of ERC-20 to support Compound-like voting and delegation. This version is more
 * generic than Compound's,
 ...
 * downside is that it
 * requires users to delegate to themselves in order to activate checkpoints and have their voting
 * power tracked.
 */
abstract contract ERC20Votes is ERC20, Votes {
   ...
   * value will not
   * remove the underlying limitation, and will cause {_update} to fail because of a math overflow
   * in
