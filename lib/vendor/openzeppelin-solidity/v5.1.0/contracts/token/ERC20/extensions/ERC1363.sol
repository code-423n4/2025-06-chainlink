...
/**
 * @title ERC1363
 * @dev Extension of {ERC20} tokens that adds support for code execution after transfers and
 * approvals
 * on recipient contracts. Calls after transfers are enabled through the {ERC1363-transferAndCall}
 * and
 * {ERC1363-transferFromAndCall} methods while calls after approvals can be made with
...
abstract contract ERC1363 is ERC20, ERC165, IERC1363 {
   ...
   * - The target must return the {IERC1363Receiver-onTransferReceived} selector to accept the
   * transfer.
   ...
   * - The target must return the {IERC1363Spender-onApprovalReceived} selector to accept the
   * approval.
